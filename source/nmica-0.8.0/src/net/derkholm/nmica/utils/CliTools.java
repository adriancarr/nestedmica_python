...
public class CliTools {
    		...
    		throws ConfigurationException
    {
        ...
        try {
            ...
            throw new ConfigurationException("Couldn't get information for target bean", ex);
        }
            ...
            if (arg.charAt(0) == '-') {
                ...
                if (arrayMode) {
                    ...
                    try {
                        ...
                        throw new ConfigurationException("Error configuring '" + pd.getName() + "'", ex.getTargetException());
                    } catch (Exception ex) {
                        throw new ConfigurationException("Error configuring '" + pd.getName() + "'", ex);
                    }
                    usedProps.add(pd);
                }
            } else {
