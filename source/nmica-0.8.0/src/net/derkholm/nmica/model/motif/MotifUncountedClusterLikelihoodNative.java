...
class MotifUncountedClusterLikelihoodNative extends MotifUncountedLikelihood {
    MotifUncountedClusterLikelihoodNative(MotifFacette mmf, SymbolList seq) 
        throws Exception
    {
        super(mmf, seq);
    }
    ...
    ) 
    {
        ...
        double hood = nativeSumMotifs(
				...
				advances, 
				motifTrans,
				facette.getClusterIn(),
				facette.getClusterOut()
		);
        return hood;
    }
